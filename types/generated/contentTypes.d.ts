...
export interface ApiHeroPageHeroPage extends Struct.CollectionTypeSchema {
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['legal', 'corporate', 'financial', 'individual', 'other']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    show_in_menu: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
